export default function PrivacyPolicy() {
  return (
    <main className="container flex flex-col items-center p-10 ">
      <div className="mx-12 flex flex-col  space-y-2 ">
        <div>
          NotesPal is committed to providing quality services to you and this
        ...
        <div>
          ...
          such use or disclosure. You may unsubscribe from our mailing/marketing
          lists at any time by contacting us in writing. When we collect
          Personal Information we will, where appropriate and where possible,
          explain to you why we are collecting the information and how we plan
          to use it.
          ...
          primary purpose for which it was obtained + For a secondary purpose
          that is directly related to the primary purpose + With your consent;
          ...
          NotesPal will not charge any fee for your access request for providing
          a copy of your Personal Information. In order to protect your Personal
